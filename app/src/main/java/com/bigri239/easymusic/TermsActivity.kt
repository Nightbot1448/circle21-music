...
class TermsActivity : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        text_view.text = "Using the EasyMusic application (hereinafter referred to as the Application) is possible only if you agree to the following terms of use (hereinafter referred to as the Terms).\n\n" +
